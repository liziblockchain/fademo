...
create channel
#peer channel create -o orderer.hunangrid.com:7050 -c mychannel -t 50 -f ./chainel-artifacts/mychannel.tx
peer channel create -o orderer.hunangrid.com:7050 -c mychannel -t 50s -f ./chainel-artifacts/mychannel.tx
...
peer chaincode instantiate -o orderer.hunangrid.com:7050 -C mychannel -n mychannel -c '{"Args":["init", "A", "10", "B", "20"]}' -P "OR ('Org1MSP.member')" -v 1.0
